...
class DegreeTest(unittest.TestCase):
    ...
    def test_temporal_degree(self):
        ...
        """
        correct_directed_in = {'d': 0.0, 'g': 0.0, 'i': 0.25, 'e': 0.25, 'b': 0.16666666666666666, 'j': 0.0,
                              'c': 0.16666666666666666, 'h': 0.25, 'a': 0.0, 'f': 0.08333333333333333}
        correct_directed_out = {'d': 0.08333333333333333, 'g': 0.08333333333333333, 'i': 0.0, 'e': 0.16666666666666666,
                               'b': 0.0, 'j': 0.08333333333333333, 'c': 0.08333333333333333, 'h': 0.4166666666666667,
                               'a': 0.25, 'f': 0.0}
